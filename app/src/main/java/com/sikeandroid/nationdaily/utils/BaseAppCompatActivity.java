...
public class BaseAppCompatActivity extends AppCompatActivity {
   ...
   */
  public void performCodeWithPermission(@NonNull String permissionDes, PermissionCallback runnable,
      ...
      new AlertDialog.Builder( this ).setTitle( "提示" )
          ...
          .setPositiveButton( "继续", new DialogInterface.OnClickListener() {
            @Override public void onClick(DialogInterface dialog, int which) {
              ActivityCompat.requestPermissions( BaseAppCompatActivity.this, permissions,
                  requestCode );
            }
          } )
          .show();
  ...
  @Override public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
    ...
    if (requestCode == permissionRequestCode) {
      if (verifyPermissions( grantResults )) {
        ...
        Toast.makeText( this, "暂无权限执行相关操作！", Toast.LENGTH_LONG ).show();
